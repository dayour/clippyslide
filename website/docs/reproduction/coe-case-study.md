...
Slide 16 tracks a single solution's config/validation health across **Dev -> Sandbox -> Prod**. It's a 3x3 matrix: `Environment / Solution / Validation` columns x three environments, color-coded by env, over the rainbow health bar.
